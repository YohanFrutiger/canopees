...
export default function TargetAudienceCard({ icon, title, text }) {
  return (
    <div className={`flex flex-col items-center text-center py-8 rounded-md border-2 border-gray-400/30 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300`}>
      {/* Icône */}
